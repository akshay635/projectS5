...
def load_data(): 
    ...
    chart_dropdown_values = {"Terrorist Organisation":'gname' , "Target Natinonality":'natlty1_txt' ,"Target Type":'targtype1_txt',
...
def create_app_ui():
    ...
    dcc.Tabs(id ="Tabs" , value ="Map", children =[
        dcc.Tab(label = "Map tool" , id = "Map tool" , value = "Map" , children = [
            ...
            html.H5('Select the Year' , id = 'year_title' , style = {'textAlign':'center' , 'color':'#FF0000'}),
            dcc.RangeSlider(
                    id = 'year-slider',
                    min = min(year_list),
                    max = max(year_list),
    ...
    html.Div(id = "graph-object" , children =":::::Graph will be shown here:::::" , style={'textAlign':'center', 'color':'#FF0000'})
    ])
